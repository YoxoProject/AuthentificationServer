...
import fr.romaindu35.authserver.entity.OAuth2RegisteredClient;
import fr.romaindu35.authserver.repository.OAuth2RegisteredClientRepository;
...
public class RedisRegisteredClientRepository implements RegisteredClientRepository {
    ...
    public void save(RegisteredClient registeredClient) {
        ...
        if (this.registeredClientRepository.findByClientId(registeredClient.getClientId()) != null) {
            //throw new IllegalArgumentException("Un client avec ce clientId existe déjà : " + registeredClient.getClientId());
            return;
        }
